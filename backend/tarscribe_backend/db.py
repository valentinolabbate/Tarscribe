...
def _run_lightweight_migrations() -> None:
    ...
    additive = [
        ...
        ("action_items", "recipient", "TEXT"),
        ("action_items", "source_quote", "TEXT"),
        ("action_items", "source_start_sec", "REAL"),
        ("action_items", "confidence", "REAL DEFAULT 0.5"),
        ("action_items", "review_state", "TEXT DEFAULT 'confirmed'"),
        ("action_items", "decision_status", "TEXT DEFAULT 'current'"),
        ("action_items", "superseded_by_id", "INTEGER"),
